...
client.connect(err => {
    ...
    const serviceCollection = client.db("electronicsRepair").collection("services");
    const reviewCollection = client.db("electronicsRepair").collection("reviews");
    const orderCollection = client.db("electronicsRepair").collection("orders");
    const adminEmailCollection = client.db("electronicsRepair").collection("emails");
